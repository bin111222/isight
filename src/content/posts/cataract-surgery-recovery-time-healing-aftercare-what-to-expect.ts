...
/** Scraped from old Wix – same URL /post/cataract-surgery-recovery-time-healing-aftercare-what-to-expect for SEO */
const post: BlogPost = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: "Vision may be blurry or hazy at first. Mild redness, scratchy sensation, and light sensitivity are common. Most patients can walk, read, and watch TV within 24–48 hours.",
    },
    {
      heading: "Week 1: Settling Vision",
      body: "Colors often appear brighter. Eye drops (antibiotic + anti-inflammatory) are crucial. Avoid heavy lifting, exercise, swimming, or rubbing the eye.",
    },
    {
      heading: "Weeks 2–4: Healing Phase",
      body: "Vision continues to sharpen. Most restrictions lifted gradually. Some patients may need glasses for fine-tuning.",
    },
    {
      heading: "Weeks 4–6: Full Recovery",
      body: "The eye is usually fully healed. Final prescription glasses (if needed) are prescribed.",
    },
    {
