...
/** Scraped from old Wix – same URL /post/pediatric-eye-doctor for SEO */
const post: BlogPost = {
  ...
  sections: [
    ...
    {
      heading: "Refraction",
      body: "Checking for glasses power using retinoscopy or auto-refractometer.",
    },
    {
      heading: "Motility (Eye Movement) Testing",
      body: "To check alignment and rule out squint.",
    },
    {
      heading: "Binocular Vision Assessment",
      body: "Depth perception and eye coordination.",
    },
    {
      heading: "Slit-Lamp Examination",
      body: "For ocular surface health.",
    },
    {
