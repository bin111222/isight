...
const post: BlogPost = {
 ...
 sections: [
 {
 heading: "LASIK Safety: The Short Answer",
 body: "LASIK is one of the most extensively studied elective surgical procedures in the world, with over 40 million procedures performed globally since its introduction. The overall satisfaction rate among LASIK patients consistently exceeds 95% across large-scale studies. In India, LASIK is performed safely at leading refractive centres in Mumbai, Delhi, Bengaluru, and other major cities, using the same globally approved laser platforms. That said, like any surgical procedure, LASIK is not risk-free, and it is not suitable for everyone. The safest LASIK is the one preceded by the most thorough pre-operative screening, and the most honest conversation about candidacy.",
 },
 {
 heading: "Who Is NOT a Good Candidate for LASIK?",
 body: "Knowing who should not have LASIK is as important as knowing the procedure details. Responsible surgeons in Mumbai will decline, or defer, surgery for patients in the following categories:",
 list: [
 ...
 {
 heading: "Serious Complications: How Rare Are They?",
 body: "Serious, long-term complications from LASIK are rare when appropriate candidacy criteria are followed. The most significant risks include:",
 list: [
 ...
 {
 heading: "What Patients on Reddit and Quora Say About LASIK in India",
 body: "Community discussions about LASIK in India, on platforms like Reddit (r/india, r/lasik) and Quora, commonly surface the following themes: patients who regret choosing the cheapest available option, patients who wish they had asked more questions about corneal thickness before consenting, patients who are very satisfied after thorough pre-op screening at reputable centres, and patients asking whether their symptoms in recovery are normal (usually yes). The consistent thread in positive outcomes: patients who chose centres based on the quality of the consultation, not the price of the advertisement. Critical forum feedback is almost always linked to inadequate candidacy screening or poor post-op care, not to the LASIK procedure itself when performed correctly.",
 },
 {
 heading: "Where to Get LASIK Safely in Mumbai",
 body: "Seek a centre that uses named, current-generation laser platforms, employs a refractive-subspecialist surgeon, conducts a full pre-operative workup before scheduling surgery, and provides a written enhancement policy. At eyesurgeonmumbai.com, the evaluation process is led by an experienced refractive surgeon and includes comprehensive corneal mapping, dry eye assessment, and an honest conversation about candidacy. Learn more at https://www.eyesurgeonmumbai.com/lasik-surgery-mumbai. Book a consultation at https://www.eyesurgeonmumbai.com/consult.",
 },
 ],
 faqs: [
 {
 q: "Is LASIK safe in India?",
 a: "LASIK is safe in India when performed at reputable centres with rigorous pre-operative screening, current laser platforms, and experienced surgeons. The main risk factor for complications, in India or anywhere, is inadequate candidacy assessment, not the procedure itself.",
 },
 {
 q: "What is the LASIK failure rate?",
 a: "The rate of serious complications leading to permanent vision loss is extremely low, less than 0.1% at well-run centres. Under-correction or regression requiring enhancement occurs in approximately 1–5% of patients over ten years. True 'failure' in the sense of worse vision than before surgery is rare when candidacy screening is thorough.",
 },
 {
 q: "How often does LASIK work?",
 a: "Approximately 90–96% of patients achieve 6/6 (20/20) or better uncorrected vision after LASIK. Patient satisfaction rates consistently exceed 95% in large studies.",
 },
 {
 q: "Is LASIK permanent?",
 a: "The corneal reshaping is permanent. However, normal age-related prescription changes can continue after LASIK, and presbyopia (reading vision difficulty after 40) is not prevented by LASIK.",
 },
 {
 q: "How often does LASIK need to be done again?",
 a: "Enhancement rates are approximately 1–5% over ten years, typically for mild regression. An enhancement is possible if sufficient corneal thickness remains.",
 },
 {
 q: "Can LASIK cause permanent dry eyes?",
 a: "Temporary dry eye is the most common LASIK side effect and usually resolves within three to six months. Permanent severe dry eye from LASIK is rare. Risk is significantly reduced with pre-operative dry eye screening and, for dry-eye-prone patients, opting for flapless procedures like SMILE.",
 },
 {
 q: "Is LASIK dangerous?",
 a: "LASIK is not dangerous for properly screened candidates. Serious, vision-threatening complications are extremely rare at experienced centres. The most important safety measure is a thorough pre-operative candidacy assessment.",
 },
 {
 q: "What are the long-term risks of LASIK?",
 a: "The main long-term considerations are: possible mild prescription regression over years (manageable with an enhancement if needed), permanent flap in the cornea (relevant for high-impact contact sports), and the ongoing natural ageing of the eye (presbyopia, eventual cataract) which LASIK does not affect.",
 },
 {
 q: "Is LASIK recommended for Indian patients with high screen time?",
 a: "Screen time contributes to dry eye, which is the primary LASIK side effect. A thorough dry eye assessment before surgery is essential for high screen-time patients in Mumbai. Flapless LASIK (SMILE or SILK) reduces post-op dryness compared to flap-based procedures.",
 },
 ],
};
