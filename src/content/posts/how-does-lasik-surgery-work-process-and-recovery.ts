...
const post: BlogPost = {
  slug: "how-does-lasik-surgery-work-process-and-recovery",
  title: "How Does LASIK Surgery Work? Process, Recovery, and Alternatives",
  description: "Learn how LASIK surgery works for vision correction, understand the recovery period, and compare LASIK vs PRK to find the best option for your eyes.",
  date: "2026-03-19",
  image: "how-does-lasik-surgery-work-process-and-recovery",
  sections: [
    {
      heading: "How Does LASIK Surgery Work for Vision Correction?",
      body: "Many patients ask, 'How does LASIK surgery work for vision correction?' The concept is beautifully simple but highly advanced in execution. The procedure involves reshaping your cornea—the clear front window of the eye—so that light traveling through it is perfectly focused onto the retina.\n\nThis precise reshaping is what instantly corrects refractive errors like myopia (nearsightedness), hyperopia (farsightedness), and astigmatism, allowing you to see clearly without glasses or contacts."
    },
    {
    ...
    },
    {
      ...
      body: "Understanding the procedure is the first step, but a thorough clinical evaluation is the only way to know which treatment is right for your unique eyes. At I-Sight Eye Care, Dr. Nikhil Nasta personally evaluates every patient to determine the safest, most effective approach.\n\nReady to ditch your glasses? Discover our advanced, bladeless LASIK options and book your consultation today. 👉 https://www.eyesurgeonmumbai.com/lasik-surgery-mumbai"
    }
  ],
  faqs: [
    {
      q: "How long is the recovery period after laser eye surgery?",
      a: "The recovery period after LASIK is remarkably fast. Most patients experience improved vision within 24 hours and can return to normal activities, like working and driving, within a day or two. Full stabilization of vision may take a few weeks to a couple of months."
    },
    {
      q: "What are the potential side effects of refractive surgery?",
      a: "Common temporary side effects include dry eyes, mild glare, halos around lights at night, and slight fluctuations in vision. These typically resolve as the eyes heal over the first few weeks or months."
    },
    {
      q: "Can minus 2.5 or minus 7.5 eyesight be cured?",
      a: "Yes, LASIK can effectively correct mild to moderate myopia, such as minus 2.5. It can also correct higher prescriptions like minus 7.5, provided the patient has adequate corneal thickness and meets other safety criteria during the pre-operative evaluation."
    },
    {
      q: "Does LASIK give 20/20 vision?",
      a: "While results vary based on individual factors, the vast majority of LASIK patients achieve 20/20 vision or better. For those with very high prescriptions, the goal is to significantly reduce dependence on glasses or contacts, even if perfect 20/20 vision isn't fully achieved."
    }
  ]
};
