...
const post: BlogPost = {
  ...
  sections: [
    ...
    {
      body: "Dr. Nikhil Nasta stresses that many complications seen later are avoidable with correct anatomy knowledge.",
    },
    {
      heading: "Why an Ophthalmic Specialist Is Best Suited",
      body: "An ophthalmic specialist:",
      list: [
    ...
    },
    {
      ...
      body: "Before treatment, Dr. Nikhil Nasta evaluates:",
      list: [
    ...
    {
      body: "This prevents cosmetic treatment from worsening hidden eye problems.",
    },
    {
    ...
    {
      body: "At I-Sight Eye Care, the ophthalmic approach is non-negotiable.",
    },
    {
  ...
  faqs: [
    {
      q: "Can non-doctors safely perform eye aesthetic treatments?",
      a: "Eye area treatments carry medical risks and should ideally be performed by trained specialists.",
    },
    {
      q: "Can fillers around the eyes affect vision?",
      a: "Yes, if performed incorrectly. This is why expertise matters.",
    },
    {
      q: "Are eye aesthetic treatments reversible?",
      a: "Some are, but complications are easier to prevent than treat.",
    },
    {
      q: "Should dry eye be evaluated before eye aesthetics?",
      a: "Yes. Treating dry eye first improves safety and outcomes.",
    },
  ],
};
