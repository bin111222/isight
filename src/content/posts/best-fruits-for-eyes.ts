...
/** Scraped from old Wix – same URL /post/best-fruits-for-eyes for SEO */
const post: BlogPost = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: "Vitamin C helps maintain the health of eye blood vessels and lowers the risk of cataracts.",
    },
    {
      heading: "2. Papaya 🥭 – Rich in Vitamin A",
      body: "Prevents night blindness and supports a healthy retina.",
    },
    {
      heading: "3. Blueberries 🫐 – Antioxidant Powerhouse",
      body: "Protects your retina from oxidative stress and may improve night vision.",
    },
    {
      heading: "4. Mangoes 🥭 – Beta-Carotene Source",
      body: "Beta-carotene converts into Vitamin A, vital for clear vision.",
    },
    {
    ...
    },
    {
      ...
      body: "These compounds protect your macula from UV light damage.",
    },
    {
      heading: "7. Guava 🍈 – Vitamin C Superfood",
      body: "Strengthens retinal health and prevents oxidative stress.",
    },
    {
      heading: "8. Pomegranate ❤️ – Improves Blood Circulation",
      body: "Better circulation means better oxygen supply to your eyes.",
    },
    {
      heading: "9. Watermelon 🍉 – Hydration + Vitamin A",
      body: "Prevents dry eyes and keeps them moist.",
    },
    {
      heading: "10. Tomatoes 🍅 – Lycopene Protection",
      body: "Lycopene helps prevent free radical damage to your retina.",
    },
    {
    ...
    },
    {
      ...
      body: "Nutritionists recommend at least 2–3 servings of mixed fruits daily to get sufficient vitamins and antioxidants. Variety is key—don’t stick to just one fruit.",
    },
    {
